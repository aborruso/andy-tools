...
| `projump` | Jump to one of the most recently active git project folders under home via `projump-path` + shell `cd` function. Cached, so it opens instantly. | [README](tools/projump/README.md) |
